...
namespace JamSpotApp.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class AdminController : Controller
    {
        ...
        public AdminController(ILogger<AdminController> logger, JamSpotDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult ToggleAdminMode(bool isAdminModeEnabled)
        {
            ...
            {
                return RedirectToAction("~/JamSpotApp/Views/Home/Index.cshtml");
            }
        }
